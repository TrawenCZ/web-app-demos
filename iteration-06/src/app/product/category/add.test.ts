...
import { addProductToCategory } from "./add";
...
describe("product/category/add", () => {
  ...
  test("Should add the specified product to the specified category", async () => {
    let result: Result<Product & { categories: Category[] }> = Result.ok({
      ...
      categories: [
        ...
        },
        {
          ...
          name: "Smartphones",
          picture:
            "https://cdn.cnn.com/cnnnext/dam/assets/210922153639-best-smartphones-lead.jpg",
        },
        {
          id: "7eef0480-a7fd-409c-984c-2a60f1d84934",
          name: "Video games",
          picture:
            "https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/most-popular-video-games-of-2022-1642612227.png?crop=1.00xw:1.00xh;0,0&resize=1200:*",
        },
      ],
    });
  ...
  test("Should not change anything - product already is in the category", async () => {
    let result: Result<Product & { categories: Category[] }> = Result.ok({
      ...
      categories: [
        ...
        },
        {
          ...
          name: "Samsung Galaxy",
          picture:
            "https://images.samsung.com/is/image/samsung/assets/ae/2201/galaxy-s21-5g/images/galaxy-s21_banner_goto_fe_s.jpg?$ORIGIN_JPG$",
        },
        {
          id: "d36c6fd3-6063-40a0-8612-a3f0b783db36",
          name: "Smartphones",
    ...
    await expect(
      addProductToCategory(
        "55b41b01-2b81-429b-8063-bc5460849e07",
        "d36c6fd3-6063-40a0-8612-a3f0b783db36"
      )
    ).resolves.toEqual(result);
  });
  ...
  test("Should fail - category does not exist", async () => {
    let result = Result.err(
      new Error(
        "Could not add a product to the category due to an unexpected error"
      )
    );
    ...
    await expect(
      addProductToCategory(
        ...
        "2d850191-0634-42ca-b08d-1cec44b9cf82"
      )
    ).resolves.toEqual(result);
  });
  ...
  test("Should fail - product does not exist", async () => {
    ...
    await expect(
      addProductToCategory(
        "08ee0d01-da22-4aab-b9ed-c55bc40bfc40",
        "d36c6fd3-6063-40a0-8612-a3f0b783db36"
      )
    ).resolves.toEqual(result);
  });
